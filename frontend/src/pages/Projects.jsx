  ...
  const fetchProjects = useCallback(async () => {
    try {
      ...
      if (role === "ADMIN" || role === "PROJECT_MANAGER") {
        ...
        console.log(
          "PROJECT COUNT:",
          projectResponse.data?.length
        );
        console.log("=================================");

        console.log("TASK DATA FROM BACKEND:");
      ...
      // =========================================
        ...
        const [projectResponse, taskResponse] =
          await Promise.all([
            axios.get(`/projects/user/${email}`),
            axios.get(`/tasks/user/${email}`),
          ]);

        console.log("TEAM MEMBER PROJECTS:");
        console.log(projectResponse.data);

        console.log("TEAM MEMBER TASKS:");
        console.log(taskResponse.data);
        ...
        const userTasks = (taskResponse.data || []).filter(
          (task) =>
        ...
        // =========================================
        // GET PROJECT IDS FROM USER TASKS
        // =========================================
